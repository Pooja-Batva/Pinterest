...
function Signup({ onClose }) {
  return (
    <div className='flex min-h-screen justify-center items-cente'>
        <div className='w-full max-w-md bg-white rounded-xl p-8 md:p-20'>
            <div className='flex flex-col items-center mb-6'>
                ...
                <h2 className='text-[1.7rem] font-bold text-center'>Welcome to Pinterest</h2>
                <p className='mt-1'>Find new ideas to try</p>
            </div>
            ...
            <p className='mt-6 text-center'>
                Already a member? {" "}
                <span className="link font-bold cursor-pointer" onClick={onClose}>
                    Log in
                </span>
            </p>
        </div>
