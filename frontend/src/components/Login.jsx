...
function Login({ onSignUpClick }) {
  return (
    <div className='flex min-h-screen justify-center items-center'>
        <div className='w-full max-w-md bg-white rounded-xl p-10 md:p-20'>
            <div className='flex flex-col items-center mb-6'>
                ...
                <h2 className='text-3xl font-bold text-center'>Welcome to Pinterest</h2>
            </div>
            ...
            <p className='mt-6 text-center'>
                ...
                <span className="link font-bold cursor-pointer" onClick={onSignUpClick}>
          Sign Up
        </span>
            </p>
        </div>
